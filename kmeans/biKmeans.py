...
def kmeans(dataSet, k):  
    ...
    print 'Congratulations, cluster using kmeans complete!'  
...
def biKmeans(dataSet, k):  
    ...
    while len(centList) < k:  
        ...
        for i in range(numCurrCluster):  
            ...
            # step 3: cluster it to 2 subclusters using kmeans  
        ...
        # step 7: update and append the centroids of the new 2 subcluster  
    ...
    print 'Congratulations, cluster using bikmeans complete!'  
    return mat(centList), clusterAssment  
  
# show your cluster only available with 2D data  
